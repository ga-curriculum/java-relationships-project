...
Create the public GitHub repo that you'll use for the project. See the [Project GitHub Repo Deliverable](./github-repo-deliverable/README.md) for more details.
